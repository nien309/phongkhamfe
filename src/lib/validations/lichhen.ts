...
export const bookingFormSchemaTaiKham = z.object({ //tái khám
...
export const bookingFormSchema = z.object({ //đặt lich hẹn
...
export const updateBookingFormSchema = z.object({ //cạp nhật lịch hẹn
